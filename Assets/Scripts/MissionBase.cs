...
public abstract class MissionBase : MonoBehaviour
{
    ...
    public int progress;
    public int reward;
    public PlayerMotorSwipe player;
...
public class SingleRun : MissionBase
{
    ...
    {
        return "RUN " + max + "METERS";
    }

    public override void RunStart()
    {
        progress = 0;
        player = FindObjectOfType<PlayerMotorSwipe>();
    }
...
public class CoinsSingleRun : MissionBase
{
    ...
    public override string GetMissionDescription()
    {
        return "GET " + max + " BATTERYS IN A RUN";
    }
